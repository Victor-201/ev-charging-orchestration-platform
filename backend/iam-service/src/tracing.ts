 ...
 *   OTEL_ENABLED=true           — Enable tracing (defaults to false in dev)
...
// Only start when explicitly enabled — avoids overhead in dev/test
  ...
  void (async () => {
    try {
      ...
      const sdk = new NodeSDK({
        // Use direct string keys for compatibility with all OTel versions
        serviceName,
      ...
      // Do not crash the app if OTel fails to initialize
